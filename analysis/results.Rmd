...
# snpRanges<-make_ranges(out$chr, out$pos, out$pos)
...
# mergedf <- IRanges::mergeByOverlaps(snpRanges, cdts_ranges)
# 
# 
# out_cdts<-apply(out, 1, function(i){
#   chrom=paste0("chr", i[1])
#   cdts_sub = cdts[cdts$chromosome == chrom,]
#   cond1 = i[2] >= cdts_sub$start
#   cond2 = i[2] <= cdts_sub$end
#   if(sum(cond1, cond2)>1){
#     return(cdts_sub[which(sum(cond1, cond2))])
#   }
# })
# 
