...
```
## What we have learned about genetics of Asthma?
...
CADD - Combined Annotation Dependent Depletion https://cadd-staging.kircherlab.bihealth.org
...
### **RNA modification - methylation at N6-adenosine**
Intro:
m6A is the most aboundant form of RNA modifications and 25-60% of mRNA transcripts found to have this type of modification. More evidence have shown that genes involve in m6A regulation and recognization have been implicated in human diseases. Previous work has provided evidence for the role of m6A variation in the genetics of immune traits. m6A-QTLs identified from 60 LCLs are largely independent of eQTLs (less than 50%) or sQTLs (same level). Additionally, genetic variants that affect m6A levels show cell-type specific effects. m6A is also found to be present in chromatin-associated RNAs, which may implicate its regulatory functions on caRNAs.  

Main Hypothesis:
1. Genetic variations that disrupt m6A modification may explain a significant fraction of human disease associations. 
2. The effects of genetic variation of m6A may vary across cell types and conditions.

*m6A modification dynamics*

* Recognized by Reader Protein: YTH family
* Methyl group added to N6-adnoesin by writer complex: METTL3/METTL14
* Methyl group removed by eraser proteins: FTO and ALKBH5



pre-mRNA splicing, RNA degradation, translation and alternative polyadenylation
*Lulio et al.*
