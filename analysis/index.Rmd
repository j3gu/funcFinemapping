...
* [fine mapping results](snp_finemapping_results.html)
    - [spliceAI as priors](snp_finemapping_spliceAI_prior.html)
...
* Functional fine-mapping
  **Post-transcriptional Regulation**
    - [SpliceAI](PTR_splicing_spliceAI.html)
    - MMSplice/MTSplice
        * [understand outputs](explore_mtsplice.html)
        * [enrichment results](PTR_splicing_mtsplice.html)
    - [m6A](PTR_m6A.html)
